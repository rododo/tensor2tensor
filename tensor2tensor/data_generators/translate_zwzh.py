...
_NC_TEST_DATASETS = [[
    ...
    ("dev/newsdev2017-enzh-ref.zh.sgm", "dev/newsdev2017-enzh-ref.zh.sgm")
]]
...
_UN_TRAIN_DATASETS = [[
    ...
    ".gz", ["en-zh/UNv1.0.en-zh.zh", "en-zh/UNv1.0.en-zh.zh"]
]]
...
class TranslateZwzhWmt32k(translate.TranslateProblem):
  ...
  def source_vocab_name(self):
    return "vocab.zwzh-zw.%d" % self.approx_vocab_size

  @property
  def target_vocab_name(self):
    return "vocab.zwzh-zh.%d" % self.approx_vocab_size
  ...
  def generate_encoded_samples(self, data_dir, tmp_dir, dataset_split):
    ...
    filename_base = "wmt_zwzh_%sk_tok_%s" % (self.approx_vocab_size, tag)
...
@registry.register_problem
class TranslateZwzhWmt8k(TranslateZwzhWmt32k):
  """Problem spec for WMT En-Zh translation.
